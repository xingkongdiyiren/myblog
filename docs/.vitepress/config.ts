    ...
    return [
        {
            ...
            text: '计算机组成', items: [
                {text: '第1章 计算机的发展历史', link: '/kaoyan/计算机组成/第1章 计算机的发展历史'},
                {text: '第2章 计算机基本组成', link: '/kaoyan/计算机组成/第2章 计算机基本组成'},
                {text: '第3章 计算机如何执行指令一', link: '/kaoyan/计算机组成/第3章 计算机如何执行指令一'},
                {text: '第4章 计算机如何执行指令二', link: '/kaoyan/计算机组成/第4章 计算机如何执行指令二'},

            ]
        }, {
            text: '计算机网络', items: [
                {text: '第1章 计算机网络基础篇', link: '/kaoyan/计算机网络/第1章 计算机网络基础篇'},
                {text: '第2章 计算机网络之HTTP', link: '/kaoyan/计算机网络/第2章 计算机网络之HTTP'},
                {text: '第3章 计算机网络之TCP', link: '/kaoyan/计算机网络/第3章 计算机网络之TCP'},
                {text: '第4章 计算机网络之IP', link: '/kaoyan/计算机网络/第4章 计算机网络之IP'},
                {text: '第5章 计算机网络之数据链路层', link: '/kaoyan/计算机网络/第5章 计算机网络之数据链路层'},
                {text: '第6章 计算机网络综合篇', link: '/kaoyan/计算机网络/第6章 计算机网络综合篇'},
