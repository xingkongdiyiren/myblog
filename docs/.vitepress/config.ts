    ...
    return [
        {
            ...
            text: '计算机组成', items: [
                ...
                {text: '第2章 计算机基本组成.md', link: '/kaoyan/计算机组成/第2章 计算机基本组成'},
                {text: '第3章 计算机如何执行指令（一）', link: '/计算机组成/计算机如何执行指令（一）'},
                {text: '第4章 计算机如何执行指令（二）', link: '/计算机组成/第4章 计算机如何执行指令（二）'},
            ...
            text: '计算机网络', items: [
                ...
                {text: '第3章 计算机网络之TCP', link: '/kaoyan/计算机网络/3章 计算机网络之TCP'},
